 ...
 * {@link com.codahale.metrics.annotation.Metric}.
 */
        ...
        for (Class<?> c = typeLiteral.getRawType(); c != Object.class; c = c.getSuperclass()) {
            for (Field field : typeLiteral.getRawType().getDeclaredFields()) {
                ...
                if (metricAnnotation != null && com.codahale.metrics.Metric.class.isAssignableFrom(field.getType())) {
                    typeEncounter.register(new MetricMembersInjector<>(metricRegistry,
                            field,
                            metricAnnotation.name(),
                            metricAnnotation.absolute()));
                }
            }
        }
    }

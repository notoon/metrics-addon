...
public class MetricIT extends AbstractSeedIT {
    ...
    public void metrics_are_preserved_between_instances() throws Exception {
        ...
        assertThat(instrumentedManually2.getCounter().getCount()).isEqualTo(1);
        instrumentedManually2.getCounter().inc();
        assertThat(instrumentedManually2.getCounter().getCount()).isEqualTo(2);
    }
}
